...
void sendDataPacket(uint8_t segNum, uint8_t *payloadBuffer, uint8_t payloadLength, uint16_t endOfPacket);
...
void sendDataPacket(uint8_t segNum, uint8_t *payloadBuffer, uint8_t payloadLength, uint16_t endOfPacketMarker)
{
